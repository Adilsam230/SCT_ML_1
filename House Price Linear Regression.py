...
try:
    df = pd.read_csv(r"C:\Users\adils\OneDrive\Documents\house_data.txt") # Replace with your file path or name
...
# Use exact, case-sensitive names that match the training data.
